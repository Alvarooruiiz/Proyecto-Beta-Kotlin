...
class ListFragment : Fragment(), OnAvatarClickListener{
...
//    lateinit var userViewModel: UserViewModel
    ...
    override fun onCreateView(
        ...
        listUsers = ArrayList()
        val rvList = view.findViewById<RecyclerView>(R.id.rvRecyclerView)
...
//        userViewModel.setUserList(listUsers)
//
//        userViewModel.getUserListLiveData().observe(viewLifecycleOwner, Observer { userList ->
...
//        })
    ...
    override fun onAvatarClick(user: User) {
        ...
        if (imageBitmaps.isEmpty()) {
            makeText(requireContext(), "No hay imágenes disponibles", LENGTH_SHORT).show()
        } else {

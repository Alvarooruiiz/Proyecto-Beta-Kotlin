...
class RecyclerAdapterList(
    ...
    fun filterUsers(query: String) {
        val filteredList = if (query.isBlank()) {
            // Si la consulta está en blanco, muestra todos los usuarios
            usuarios.toList()
        } else {
            // Filtra la lista de usuarios basándose en la consulta
        ...
        // Actualiza los datos del adaptador con la lista filtrada
    ...
    fun setOnAvatarClickListener(listener: ListFragmentBaja) {
